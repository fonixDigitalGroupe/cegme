    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            <div class="flex justify-start">
                <x-primary-button class="bg-gradient-to-b from-green-600 to-emerald-500 hover:from-green-700 hover:to-emerald-600 focus:from-green-700 focus:to-emerald-600 active:from-green-800 active:to-emerald-700 focus:ring-green-500" style="background: linear-gradient(180deg, rgb(10, 150, 120) 0%, rgb(16, 185, 150) 100%);">
                    {{ __('Connexion') }}
                </x-primary-button>
            </div>
