    ...
    <body class="bg-white text-[#1b1b18] min-h-screen" style="background-color: #ffffff !important;">
        ...
        <section class="w-full px-4 sm:px-6 lg:px-8" style="padding: 96px 0; background-color: #F9FAFB;">
            <div class="max-w-7xl mx-auto">
                <div class="flex flex-row gap-8 items-start justify-between actualites-main-row" style="display: flex; flex-direction: row; gap: 32px; align-items: flex-start; justify-content: space-between;">
                    <!-- Left Column - Two separate blocks -->
                    <div class="actualites-left-column" style="max-width: 400px; width: 100%; flex-shrink: 0; display: flex; flex-direction: column; gap: 24px;">
            ...
            <div class="max-w-7xl mx-auto" style="padding: 0px;">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12" style="display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 48px; margin-bottom: 48px; padding: 0px;">
                    <div>
                        ...
                        <p class="text-gray-200 text-sm leading-relaxed" style="font-size: 14px; color: rgb(209, 213, 219); line-height: 22px; margin: 0;">
