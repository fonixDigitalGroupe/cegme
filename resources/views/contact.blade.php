    ...
    <section class="w-full bg-white px-4 sm:px-6 lg:px-8" style="padding: 96px 0;">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 contact-cards-grid"
                style="display: grid; gap: 32px; margin-bottom: 64px;">
                <!-- Card 1: Adresse -->
                <div class="bg-white rounded-lg p-6 shadow-md text-center contact-info-card"
                    ...
                    <div class="w-16 h-16 rounded-lg flex items-center justify-center mx-auto mb-4 contact-icon-address"
                        style="width: 64px; height: 64px; border-radius: 12px; background-color: #10b981; display: flex; align-items: center; justify-content: center; margin: 0 auto 16px;">
                ...
                <div class="bg-white rounded-lg p-6 shadow-md text-center contact-info-card"
                    style="background-color: rgb(255, 255, 255); border-radius: 8px; padding: 24px; box-shadow: rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.1) 0px 4px 6px -4px; text-align: center;">
                    <div class="w-16 h-16 rounded-lg flex items-center justify-center mx-auto mb-4 contact-icon-email"
                        style="width: 64px; height: 64px; border-radius: 12px; background-color: #3b82f6; display: flex; align-items: center; justify-content: center; margin: 0 auto 16px;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none"
                            stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            style="width: 32px; height: 32px; color: white;">
                ...
                <div class="bg-white rounded-lg p-6 shadow-md text-center contact-info-card"
                    style="background-color: rgb(255, 255, 255); border-radius: 8px; padding: 24px; box-shadow: rgba(0, 0, 0, 0.1) 0px 10px 15px -3px, rgba(0, 0, 0, 0.1) 0px 4px 6px -4px; text-align: center;">
                    <div class="w-16 h-16 rounded-lg flex items-center justify-center mx-auto mb-4 contact-icon-phone"
                        style="width: 64px; height: 64px; border-radius: 12px; background: linear-gradient(45deg, #c026d3, #ec4899); display: flex; align-items: center; justify-content: center; margin: 0 auto 16px;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none"
                            stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                            style="width: 32px; height: 32px; color: white;">
                            <path
                ...
                <form method="POST" action="{{ route('contact.send') }}"
                    ...
                    <div class="text-center" style="text-align: center;">
                        <button type="submit"
                            ...
                            style="display: inline-flex; align-items: center; gap: 8px; padding: 16px 32px; background-color: #059669; color: rgb(255, 255, 255); border-radius: 8px; font-size: 16px; font-weight: 600; border: none; cursor: pointer;">
