...
<div style="margin-bottom: 4rem; display: flex; justify-content: space-between; align-items: center;">
    <h1 style="font-size: 1.5rem; font-weight: 600; color: #111827; margin: 0;">Gestion des utilisateurs</h1>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $user->email }}</td>
                <td>
                    <span style="display: inline-block; padding: 0.25rem 0.75rem; border-radius: 9999px; font-size: 0.75rem; font-weight: 500; {{ $user->role ? 'background-color: #d1fae5; color: #065f46;' : 'background-color: #f3f4f6; color: #6b7280;' }}">
                        {{ $user->role->display_name ?? 'Aucun rôle' }}
                    </span>
                </td>
                <td style="text-align: right;">
                    <div style="display: flex; align-items: center; justify-content: flex-end; gap: 0.75rem;">
                        <a href="{{ route('admin.users.edit', $user) }}" class="btn-link" style="display: inline-flex; align-items: center; gap: 0.375rem; margin-right: 0;">
            ...
            @empty
            <tr>
                <td colspan="4" style="text-align: center; padding: 2rem; color: #6b7280;">Aucun utilisateur trouvé</td>
            </tr>
            @endforelse
        </tbody>
    </table>
