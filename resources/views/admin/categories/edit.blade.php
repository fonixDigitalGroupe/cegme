...
<div style="max-width: 600px; margin: 0 auto;">
    <div style="margin-bottom: 1.5rem; text-align: center;">
        <h1 style="font-size: 1.5rem; font-weight: 600; color: #1a1a1a; margin: 0; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">Modifier une catégorie</h1>
    </div>
...
<form action="{{ route('admin.categories.update', $category) }}" method="POST">
    ...
    <div style="background-color: #ffffff; border: 1px solid #d1d5db; border-radius: 4px; padding: 1.5rem;">
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <input type="text" name="name" id="category-name" value="{{ old('name', $category->name) }}" required class="form-input" placeholder="Nom de la catégorie" style="width: 100%; padding: 0.625rem 0.875rem; border: 1px solid #d1d5db; border-radius: 4px; font-size: 0.875rem; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
        ...
        <div style="margin-bottom: 1.5rem;">
            ...
            <textarea name="description" id="category-description" rows="3" class="form-input" placeholder="Description de la catégorie (optionnel)" style="width: 100%; padding: 0.625rem 0.875rem; border: 1px solid #d1d5db; border-radius: 4px; font-size: 0.875rem; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">{{ old('description', $category->description) }}</textarea>
