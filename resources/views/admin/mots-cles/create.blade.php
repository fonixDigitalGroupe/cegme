...
@section('title', 'Créer un mot-clé')

@section('content')
<div style="margin-bottom: 1.5rem;">
    <h1 style="font-size: 1.5rem; font-weight: 600; color: #1a1a1a; margin: 0; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">Créer un mot-clé</h1>
</div>

<form action="{{ route('admin.mots-cles.store') }}" method="POST">
    @csrf
