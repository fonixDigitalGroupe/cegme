...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-white text-[#1b1b18] min-h-screen" style="background-color: #ffffff !important;">
                ...
                <div style="max-width: 900px; margin: 0 auto;">
                    ...
                    <div style="margin-bottom: 40px;">
                        <a href="{{ route('blog.index') }}" style="color: rgba(255, 255, 255, 0.7); text-decoration: none; font-size: 13px; font-weight: 500; display: inline-flex; align-items: center; gap: 10px; transition: all 0.3s ease; letter-spacing: 0.5px; text-transform: uppercase; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;" onmouseover="this.style.color='rgba(255, 255, 255, 1)'; this.style.gap='12px';" onmouseout="this.style.color='rgba(255, 255, 255, 0.7)'; this.style.gap='10px';">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width: 14px; height: 14px;">
                    ...
                    @if($post->category)
                        <div style="margin-bottom: 24px;">
                            <span style="display: inline-block; padding: 6px 16px; background-color: rgba(255, 255, 255, 0.1); border: 1px solid rgba(255, 255, 255, 0.15); color: rgba(255, 255, 255, 0.85); font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 1.5px; border-radius: 4px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
                                {{ $post->category->name }}
                            </span>
                        </div>
                    @endif
                    ...
                    <div style="margin-bottom: 48px;">
                        <h1 style="font-size: clamp(42px, 6vw, 64px); font-weight: 700; color: rgb(255, 255, 255); line-height: 1.1; text-align: left; letter-spacing: -1px; margin: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
                            {{ $post->title }}
                        </h1>
                    </div>
                    
                    <!-- Métadonnées élégantes -->
                    <div style="display: flex; align-items: center; gap: 28px; flex-wrap: wrap; color: rgba(255, 255, 255, 0.75); font-size: 14px; font-weight: 400; padding-top: 32px; border-top: 1px solid rgba(255, 255, 255, 0.15); font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
                        <span style="display: inline-flex; align-items: center; gap: 8px; font-weight: 400;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 16px; height: 16px; opacity: 0.6;">
        ...
        <section class="w-full bg-white" style="padding: 100px 0 80px; min-height: 300px; background: #ffffff;">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="article-content-wrapper" style="max-width: 900px; margin: 0 auto; padding: 0 60px;">
                    @if($post->excerpt)
                        <div class="excerpt" style="background: #f8f9fa; border-left: 3px solid #1a1a1a; padding: 40px 48px; margin-bottom: 64px; margin-top: -20px; font-size: 24px; color: #2d2d2d; line-height: 1.65; font-weight: 400; letter-spacing: -0.3px; font-family: 'Georgia', 'Times New Roman', serif; font-style: italic;">
                            {{ $post->excerpt }}
                        </div>
                    @endif

                    <div class="article-content" style="font-family: 'Georgia', 'Times New Roman', 'Times', serif; font-size: 22px; line-height: 1.8; color: #1a1a1a; letter-spacing: -0.01em; font-weight: 400;">
                        {!! $post->content !!}
                    </div>
                    ...
                    @if($post->tags->count() > 0)
                        <div style="margin-top: 48px; padding-top: 32px; border-top: 1px solid #e5e7eb;">
                            <h3 style="font-size: 11px; font-weight: 600; color: #6b7280; margin-bottom: 16px; text-transform: uppercase; letter-spacing: 2px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">Mots-clés</h3>
                            <div style="display: flex; flex-wrap: wrap; gap: 8px;">
                                @foreach($post->tags as $tag)
                                    <span style="display: inline-flex; align-items: center; gap: 6px; padding: 6px 14px; background-color: #f3f4f6; color: #374151; border: none; border-radius: 4px; font-size: 13px; font-weight: 500; transition: all 0.2s ease; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;" onmouseover="this.style.backgroundColor='#e5e7eb'; this.style.color='#1f2937';" onmouseout="this.style.backgroundColor='#f3f4f6'; this.style.color='#374151';">
                                        {{ $tag->name }}
                                    </span>
                                @endforeach
                            </div>
                    ...
                    <div style="margin-top: 80px; padding-top: 48px; border-top: 1px solid #e5e7eb;">
                        <h3 style="font-size: 11px; font-weight: 600; color: #6b7280; margin-bottom: 24px; text-transform: uppercase; letter-spacing: 2px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">Partager cet article</h3>
                        <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->fullUrl()) }}" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; width: 44px; height: 44px; background-color: #1877F2; color: rgb(255, 255, 255); border: none; border-radius: 6px; text-decoration: none; transition: all 0.2s ease; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;" onmouseover="this.style.backgroundColor='#166FE5'; this.style.transform='translateY(-1px)';" onmouseout="this.style.backgroundColor='#1877F2'; this.style.transform='translateY(0)';" title="Partager sur Facebook">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                                </svg>
                            </a>
                            <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(request()->fullUrl()) }}" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; width: 44px; height: 44px; background-color: #0077B5; color: rgb(255, 255, 255); border: none; border-radius: 6px; text-decoration: none; transition: all 0.2s ease; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;" onmouseover="this.style.backgroundColor='#006399'; this.style.transform='translateY(-1px)';" onmouseout="this.style.backgroundColor='#0077B5'; this.style.transform='translateY(0)';" title="Partager sur LinkedIn">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href="https://twitter.com/intent/tweet?url={{ urlencode(request()->fullUrl()) }}&text={{ urlencode($post->title) }}" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; width: 44px; height: 44px; background-color: #000000; color: rgb(255, 255, 255); border: none; border-radius: 6px; text-decoration: none; transition: all 0.2s ease; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;" onmouseover="this.style.backgroundColor='#1a1a1a'; this.style.transform='translateY(-1px)';" onmouseout="this.style.backgroundColor='#000000'; this.style.transform='translateY(0)';" title="Partager sur X (Twitter)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"></path>
                                </svg>
                            </a>
                            <a href="https://wa.me/?text={{ urlencode($post->title . ' ' . request()->fullUrl()) }}" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; width: 44px; height: 44px; background-color: #25D366; color: rgb(255, 255, 255); border: none; border-radius: 6px; text-decoration: none; transition: all 0.2s ease; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;" onmouseover="this.style.backgroundColor='#20BA5A'; this.style.transform='translateY(-1px)';" onmouseout="this.style.backgroundColor='#25D366'; this.style.transform='translateY(0)';" title="Partager sur WhatsApp">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <a href="https://www.instagram.com/" target="_blank" style="display: inline-flex; align-items: center; justify-content: center; width: 44px; height: 44px; background: linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%); color: rgb(255, 255, 255); border: none; border-radius: 6px; text-decoration: none; transition: all 0.2s ease; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;" onmouseover="this.style.transform='translateY(-1px)'; this.style.opacity='0.9';" onmouseout="this.style.transform='translateY(0)'; this.style.opacity='1';" title="Partager sur Instagram">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <section class="w-full bg-white" style="padding: 100px 0; border-top: 1px solid #e5e7eb; background: #ffffff;">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div style="text-align: center; margin-bottom: 64px;">
                        <h2 style="font-size: 36px; font-weight: 700; color: #1a1a1a; margin-bottom: 16px; letter-spacing: -1px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">Articles similaires</h2>
                        <p style="font-size: 16px; color: #6b7280; max-width: 600px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">Découvrez d'autres articles qui pourraient vous intéresser</p>
                    </div>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 40px;">
                        @foreach($relatedPosts as $relatedPost)
                            <article style="background-color: #ffffff; border-radius: 0; overflow: hidden; border: 1px solid #e5e7eb; transition: all 0.3s ease;" onmouseover="this.style.borderColor='#d1d5db'; this.style.transform='translateY(-2px)';" onmouseout="this.style.borderColor='#e5e7eb'; this.style.transform='translateY(0)';">
                                @if($relatedPost->featured_image)
                                    <a href="{{ route('blog.show', $relatedPost->slug) }}" style="display: block; overflow: hidden;">
                                        <img src="{{ asset('storage/' . $relatedPost->featured_image) }}" alt="{{ $relatedPost->title }}" style="width: 100%; height: 240px; object-fit: cover; transition: transform 0.3s ease;" onmouseover="this.style.transform='scale(1.03)';" onmouseout="this.style.transform='scale(1)';">
                                    </a>
                                @endif
                                <div style="padding: 32px;">
                                    @if($relatedPost->category)
                                        <span style="display: inline-block; padding: 4px 12px; background-color: #f3f4f6; color: #374151; border-radius: 4px; font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 1.5px; margin-bottom: 20px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
                                            {{ $relatedPost->category->name }}
                                        </span>
                                    @endif
                                    <h3 style="font-size: 24px; font-weight: 700; color: #1a1a1a; margin-bottom: 16px; line-height: 1.3; letter-spacing: -0.5px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
                                        <a href="{{ route('blog.show', $relatedPost->slug) }}" style="color: inherit; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#000000';" onmouseout="this.style.color='#1a1a1a';">
                                            {{ $relatedPost->title }}
                                        </a>
                                    </h3>
                                    @if($relatedPost->excerpt)
                                        <p style="font-size: 16px; color: #6b7280; line-height: 1.6; margin-bottom: 20px; font-family: 'Georgia', 'Times New Roman', serif;">
                                            {{ \Illuminate\Support\Str::limit($relatedPost->excerpt, 140) }}
                                        </p>
                                    @endif
                                    <div style="display: flex; align-items: center; gap: 8px; font-size: 13px; color: #9ca3af; font-weight: 400; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
        ...
        <style>
            ...
            .article-content h1:not([style*="font-size"]) { font-size: 36px; }
            .article-content h2:not([style*="font-size"]) { font-size: 30px; }
            .article-content h3:not([style*="font-size"]) { font-size: 24px; }
            .article-content h4:not([style*="font-size"]) { font-size: 20px; }
            .article-content h5:not([style*="font-size"]) { font-size: 18px; }
